...
Refactored entry point using a shared controller.
Navigate the board and find polyomino shapes hidden in the grid.
"""
...
from polyomino_controller import (
    PolyominoController,
    BOARD_MIN, BOARD_MAX, BOARD_DEFAULT, FPS,
    SHAPES_CHOICES, DENSITY_CHOICES, COLORS_CHOICES, CLOCK_MODES, MAX_CLOCK_SECONDS,
...
def main() -> None:
    ...
    menu_items = [
        ...
        ("clock", [0] + list(range(30, MAX_CLOCK_SECONDS, 30)), 0),  # 0 = no limit
    ...
    # --- controller ---
    controller = PolyominoController(

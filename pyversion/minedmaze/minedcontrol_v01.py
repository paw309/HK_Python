...
Two-player competitive Mined Maze.  Both players share the same generated
maze and race to reach the target square first.  Supports human vs bot,
bot vs human, and clock-limited play.
"""
...
from pyversion.minedmaze.minedcontrol_controller import (
    MinedMaze2Controller, BOARD_MIN, BOARD_MAX, BOARD_DEFAULT, FPS,
...
def main() -> None:
    ...
    pygame.display.set_caption("Mined Control")
    ...
    menu_items = [
        ...
        ("level",      OPPONENT_LEVEL_CHOICES[:],             0),
        ("clock",      [0] + list(range(30, 330, 30)), 0),  # 0 = infinity
    ...
    # --- controller ---
    controller = MinedMaze2Controller(

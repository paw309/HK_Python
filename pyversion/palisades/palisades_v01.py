"""
Palisades v01 — Non-Crossing Knight's Tour
...
from palisades_controller import (
    PalisadesController,
    BOARD_MIN, BOARD_MAX, BOARD_DEFAULT, FPS,
    MAX_CLOCK_SECONDS, FIRST_SQUARE_CHOICES, CLOCK_MODES,
...
def main() -> None:
    ...
    pygame.display.set_caption("Palisades")
    ...
    menu_items = [
        ...
        ("clock", [0] + list(range(30, MAX_CLOCK_SECONDS, 30)), 0),
    ...
    controller = PalisadesController(
